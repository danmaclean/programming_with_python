--- 
title: "Beginning Python For Programming"
author: "Dan MacLean"
date: "`r Sys.Date()`"
...
You can use `conda` to install new Python packages with `conda install <package_name>`.
...
A text editor is a program that deals with text but not in the same way as a word processor. Many such programs are available, try the options below
